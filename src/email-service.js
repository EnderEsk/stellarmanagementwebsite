...
class EmailService {
        ...
        const htmlContent = `
            ...
            <head>
                ...
                <style>
                    ...
                    .cta-section {
                        background: linear-gradient(135deg, #8cc63f 0%, #7cb342 100%);
                        border-radius: 12px;
                        padding: 30px;
                        text-align: center;
                        margin: 30px 0;
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="content">
                        ...
                        <div class="next-steps">
                            ...
                            <ul class="steps-list">
                                ...
                                <li class="step-item">
                                    ...
                                    <div class="step-content">
                                        <div class="step-title">Site Visit & Assessment</div>
                                        <div>We'll arrange an on-site inspection to provide an accurate quote</div>
                                    </div>
                                </li>
                                <li class="step-item">
                                    ...
                                    <div class="step-content">
                                        ...
                                        <div>We'll prepare a detailed quote based on our assessment</div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="cta-section">
                            <div class="cta-title">📱 Track Your Quote Status</div>
                            <div class="cta-text">
                                Stay updated on your quote progress and view all details in one place.
                            </div>
                            <a href="https://stellartreemanagement.ca/booking-status.html?id=${bookingId}" class="cta-button">
                        ...
                        <div class="important-notice">
                            ...
                            <p class="notice-text">This is a quote request. Your appointment is not yet confirmed. We will contact you within 24 hours to arrange an on-site inspection.</p>
                        </div>
    ...
    async sendQuoteReadyEmail(email, bookingId, service, date, time, name, address, notes, estimatedCost, workDescription) {
        const subject = `Your Quote is Ready - ${bookingId}`;
        ...
        const htmlContent = `
            ...
            <head>
                <meta charset="UTF-8">
                <meta name="viewport" content="width=device-width, initial-scale=1.0">
                <title>Quote Ready - ${bookingId}</title>
                <style>
                    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Poppins:wght@400;500;600;700&display=swap');
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="content">
                        ...
                        <div class="intro-text">
                            Great news! Your quote is ready. After our on-site assessment, we've prepared a detailed quote for your tree service needs. Here are the details:
                        </div>
                        ...
                        <div class="cost-section">
                            ...
                            <p style="margin: 0; opacity: 0.9;">This is our best estimate based on our on-site assessment</p>
                        </div>
                        
                        <div class="cta-section">
                            <div class="cta-title">📋 Review Your Quote</div>
                            <div class="cta-text">
                                View the complete quote details and accept or request modifications.
                            </div>
                            <a href="https://stellartreemanagement.ca/booking-status.html?id=${bookingId}" class="cta-button">
                                View Your Quote
                            </a>
                        ...
                        <p style="color: #5a5a5a; margin-bottom: 0; text-align: center; font-size: 14px;">
                            If you have any questions about this quote or would like to discuss modifications, please contact us at stellartmanagement@outlook.com
                        </p>
                    </div>
        ...
        const textContent = `
            ...
            Great news! Your quote is ready. After our on-site assessment, we've prepared a detailed quote for your tree service needs.
            ...
            View your complete quote and accept or request modifications at:
            https://stellartreemanagement.ca/booking-status.html?id=${bookingId}
            
            If you have any questions about this quote, please contact us at stellartmanagement@outlook.com
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="content">
                        ...
                        <div class="cta-section" style="background: linear-gradient(135deg, #8cc63f 0%, #7cb342 100%); border-radius: 12px; padding: 25px; text-align: center; margin: 30px 0;">
                            <div class="cta-title" style="font-size: 18px; font-weight: 700; color: white; margin-bottom: 15px;">🏢 View in Admin Panel</div>
                            <div class="cta-text" style="color: rgba(255, 255, 255, 0.9); margin-bottom: 20px; font-size: 14px;">
                                Access the full booking details and manage this quote request from your admin panel.
                            </div>
                            <a href="https://stellartreemanagement.ca/admin.html" class="cta-button" style="background: white; color: #8cc63f; padding: 12px 25px; border-radius: 25px; text-decoration: none; font-weight: 600; font-size: 14px; display: inline-block; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
                                Open Admin Panel
                            </a>
                        </div>
